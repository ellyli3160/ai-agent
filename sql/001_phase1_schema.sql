...
--
-- 已在 daily-us-stock 專案實測（2026-09-22）：兩個案例皆正確。
-- 第二個案例原本的註解寫錯了（誤以為是 3 天），已更正：
-- 09-04（五）之後依序是週末、09-07（一，勞動節休市）、09-08（二）、09-09（三），
-- 扣掉週末與假日只剩 2 個交易日，函式回傳 2 才是對的。
-- ----------------------------------------------------------------------------
-- 2026-08-24（一）到 2026-08-27（四）應為 3 個交易日
select trading_days_between('2026-08-24', '2026-08-27') as should_be_3;
-- 跨越勞動節（2026-09-07 週一休市）：09-04（五）到 09-09（三）應為 2 個交易日
select trading_days_between('2026-09-04', '2026-09-09') as should_be_2_across_holiday;
